...
masterfile = select(master.file, c(dist_id, sex, ethn, age_first_egfr, first_egfr, first_ckd_stage, age_last_egfr, last_egfr, last_ckd_stage, n_egfr, followup_yrs, corrected_slope, corrected_r2, obsv_esrd_fu_yrs, icd_esrd_fu_yrs, icd_dialysis_fu_yrs, icd_kidney_tx_fu_yrs, uncorrected_slope))

write.table(masterfile, file = "masterfile.tsv", sep = "\t", row.names = FALSE)
